...
export function ForestBackdrop() {
  return (
    <div style={{ ...backdropBase, background: 'linear-gradient(180deg,#0a1a12 0%,#0f2418 45%,#183321 75%,#1f3d26 100%)' }}>
      ...
      {/* soft foliage massing, pushed off to the far edges so it reads as
          the treeline framing the clearing rather than pillars in the room */}
      <div
        style={{
          position: 'absolute',
          left: -80,
          ...
          height: '85%',
          borderRadius: '50%',
          background: 'radial-gradient(ellipse at 30% 70%, rgba(10,20,10,0.9) 0%, rgba(10,20,10,0) 70%)',
          filter: 'blur(6px)',
        }}
      />
      <div
        style={{
          ...
          height: '85%',
          borderRadius: '50%',
          background: 'radial-gradient(ellipse at 70% 70%, rgba(10,20,10,0.9) 0%, rgba(10,20,10,0) 70%)',
          filter: 'blur(6px)',
        }}
      />
      {/* vignette to keep focus on the centered UI */}
      <div
        style={{
          position: 'absolute',
          inset: 0,
